...
import { getHeadcountRequestById } from 'apiSdk/headcount-requests';
...
function HeadcountRequestViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Headcount Request Detail View
          </Text>
          {hasAccess('headcount_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/headcount-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              ...
              {hasAccess('stakeholder', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/stakeholders/view/${data?.stakeholder?.id}`}>
                      {data?.stakeholder?.id}
                    </Link>
                  </Text>
                </Flex>
